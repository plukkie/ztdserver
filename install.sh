...
CGISCRIPT_TER=cleanup_ztpfinish.sh
...
chmod a+x ${CGISCRIPT} && chmod a+x ${CGISCRIPT_SEC} && chmod a+x ${CGISCRIPT_TER}
...
${DOCKER} cp ${CGISCRIPT_TER} ${HTTPCONTAINERNAME}:${APACHECGIPATH}/${CGISCRIPT_SEC}
